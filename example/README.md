...
## Launching aviatrix_controller_build module, aviatrix_controller_initialize module or the entire OCI controller module (build + init)

The following example will launch aviatrix_controller_build module,  aviatrix_controller_initialize module or the entire OCI controller module (build + init)
